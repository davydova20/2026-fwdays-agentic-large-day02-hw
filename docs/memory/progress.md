...
- Documented **memory bank upkeep**: `docs/memory/README.md` (when to update each file; agent workflow).
- Added **Cursor rules**: `.cursor/rules/excalidraw-architecture.mdc`, `conventions.mdc`, `do-not-touch.mdc`.
- **`AGENTS.md`**: Memory Bank section points to `docs/memory/README.md`; removed stray `</CodeBlockWrapper>` markup after the commands block.
